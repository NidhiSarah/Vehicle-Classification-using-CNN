...
model = keras.Sequential([
    layers.Conv2D(32, (3, 3), activation=tf.keras.layers.LeakyReLU(alpha=0.1), input_shape=input_shape, kernel_regularizer=keras.regularizers.l2(0.001)),
...
model_checkpoint = keras.callbacks.ModelCheckpoint('cnnact_vehicle_classifier.h5', save_best_only=True)
...
# Save the model
model.save(r'C:\Users\NST37\AI Project\Kaggle\cnnact_vehicle_classifier.h5')
